...
export function useFirebaseStore(): UseFirebaseStoreReturn {
  ...
  // Collections to sync
  const collections: CollectionName[] = ['crawlers', 'mobs', 'maps', 'inventory', 'episodes', 'soundEffects', 'diceRolls', 'lootBoxes', 'lootBoxTemplates', 'noncombatTurns', 'gameClock', 'combatState'];
